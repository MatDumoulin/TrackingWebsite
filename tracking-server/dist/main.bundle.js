...
var CurrentUserService = (function () {
    function CurrentUserService(trackeeService) {
    ...
    CurrentUserService.prototype.updateUser = function (changes) {
        this.trackeeService.updateTrackee(this.user.authId, changes).then(function (res) { return console.log(res); });
    };
...
var uuid = __webpack_require__("../../../../uuid/v1.js");
var current_user_service_1 = __webpack_require__("../../../../../src/app/data-services/current-user/current-user.service.ts");
var crypto_service_1 = __webpack_require__("../../../../../src/app/core/crypto/crypto.service.ts");
var RoomService = (function () {
    function RoomService(db, cryptoService, currentUserService) {
        this.db = db;
        this.cryptoService = cryptoService;
        this.currentUserService = currentUserService;
        this.ROOM_PATH = 'rooms';
    }
    RoomService.prototype.getRoom = function (id, password) {
        var key = this.getRoomKey(id, password);
        return this.db.object(this.ROOM_PATH + "/" + key).valueChanges();
    };
    RoomService.prototype.createRoom = function (id, password, room) {
        var _this = this;
        var key = this.getRoomKey(id, password);
        ...
        return new Promise(function (resolve, reject) {
            var roomRef = _this.db.object(_this.ROOM_PATH + "/" + key);
            var obs = roomRef.valueChanges().subscribe(function (res) {
                if (!res) {
                    obs.unsubscribe();
                    roomRef.set(newRoom).then(function () { return resolve(newRoom); })
    ...
    RoomService.prototype.getRoomKey = function (id, password) {
...
var ClientCreateComponent = (function () {
    ...
    ClientCreateComponent.prototype.joinRoom = function () {
        var _this = this;
        this.roomService.getRoom(this.currentRoom, this.password).subscribe(function (room) {
            if (!room) {
            ...
            _this.logger.info("You don't have the permissions needed to join this room.");
            console.log(err);
        });
    };
...
var ClientComponent = (function () {
    function ClientComponent(currentUserService, dialog) {
        this.currentUserService = currentUserService;
        this.dialog = dialog;
        ...
        this.userObs = this.currentUserService.userTrackee.subscribe(function (trackee) {
            ...
            setTimeout(function () {
                if (!_this.hasOpenDialog) {
                    _this.openCreateClientDialog();
                    _this.hasOpenDialog = true;
                }
            });
    ...
    ClientComponent.prototype.openCreateClientDialog = function () {
        var _this = this;
        this.dialog.open(client_create_component_1.ClientCreateComponent, { disableClose: true }).afterClosed()
            .subscribe(function (response) {
            // Ignoring when the user cancels zone search.
            if (response && response.hasJoined) {
                _this.currentUserService.updateUser({ room: response.room.id });
                _this.startTracking();
            }
        });
    };
    ...
    ClientComponent.prototype.emitLocation = function () {
        ...
        navigator.geolocation.getCurrentPosition(function (pos) {
            _this.currentUserService.updateUser({ lat: pos.coords.latitude, lon: pos.coords.longitude });
        });
    };
    ...
    ClientComponent = __decorate([
        ...
        __metadata("design:paramtypes", [current_user_service_1.CurrentUserService, material_1.MatDialog])
    ], ClientComponent);
...
var MapsManagerComponent = (function () {
    function MapsManagerComponent(trackeeService, mapsAPILoader, ngZone) {
        this.trackeeService = trackeeService;
    ...
    MapsManagerComponent.prototype.ngOnInit = function () {
        ...
        this.trackeeService.fetchTrackeesByRoom(4).subscribe(function (trackees) { return _this.updateMarkerList(trackees); });
    };
    // Not working
...
module.exports = "<div class=\"container mat-elevation-z8\">\n    <h1>Hi there, what can I do for you?</h1>\n    <div class=\"action-buttons\">\n        <a color=\"primary\" routerLink='join' mat-raised-button>Join a room</a>\n        <a color=\"primary\" routerLink='create' mat-raised-button>Create a room</a>\n    </div>\n</div>\n"
...
var appRoutes = [
    ...
    { path: 'create', component: maps_manager_component_1.MapsManagerComponent, canActivate: [auth_guard_service_1.AuthGuardService] },
    { path: 'join', component: client_component_1.ClientComponent, canActivate: [auth_guard_service_1.AuthGuardService] },
